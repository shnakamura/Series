...
public class VultureProjectile : ModProjectile
{
    ...
    public override void AI()
    {
        ...
        {
            var direction = Math.Sign(Main.MouseWorld.X - Owner.Center.X);
    ...
    private void UpdateMovement()
    {
        ...
        var position = Owner.Center + new Vector2(-Owner.direction * 48f, -24f);
    ...
    private void UpdateShooting()
    {
        ...
        var position = Projectile.Center + new Vector2(Projectile.direction * 32f, 8f);
